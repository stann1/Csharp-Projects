...
namespace SideshowBob
{
    class ConsoleApp
    {
        static void Main()
        {
            ...
            AuthorisedDealer.Instance.AddVehicle(new Motorcycle("blue", 2, Model.KawasakiNinja, DateTime.Parse("06/8/2008"), 35000.0m, true, false, 320));
            ...
            //LINQ queries
            Console.WriteLine("Vehicles produced after 2010 year");
            var collection = AuthorisedDealer.Instance.SelectVehiclesAfterYear(2010);
            ...
            Console.WriteLine("Vehicles over 40 000");
