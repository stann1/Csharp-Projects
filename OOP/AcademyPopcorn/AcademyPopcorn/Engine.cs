...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        public ushort SleepInterval { get; private set; }                         //task 2 - setting sleep timer

        public Engine(IRenderer renderer, IUserInterface userInterface, ushort sleepInterval)
        {
        ...
        {
            allObjects.RemoveAll(x => x is Racket);             //This will remove previous rackets
